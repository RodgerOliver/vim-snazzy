...
:exe   'highlight DiffAdd         guifg='.green.'    guibg='.ui_11.'   guisp=NONE        gui=NONE,reverse   ctermfg=112   ctermbg=239   cterm=NONE,reverse'
:exe   'highlight DiffDelete      guifg='.red.'      guibg='.ui_11.'   guisp=NONE        gui=NONE,reverse   ctermfg=196   ctermbg=239   cterm=NONE,reverse'
:exe   'highlight DiffChange      guifg='.yellow.'   guibg='.ui_11.'   guisp=NONE        gui=NONE,reverse   ctermfg=220   ctermbg=239   cterm=NONE,reverse'
:exe   'highlight DiffText        guifg='.blue.'     guibg='.ui_11.'   guisp=NONE        gui=NONE,reverse   ctermfg=39    ctermbg=239   cterm=NONE,reverse'
:exe  'highlight  ErrorMsg        guifg='.red.'      guibg='.ui_11.'   guisp='.ui_11.'   gui=NONE       ctermfg=203   ctermbg=237   cterm=NONE,reverse'
...
:exe  'highlight  Visual          guifg=NONE         guibg='.ui_9.'     guisp='.ui_1.'     gui=NONE       ctermfg=NONE   ctermbg=247   cterm=NONE'
